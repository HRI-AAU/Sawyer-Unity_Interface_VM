...
robot_hostname="021802CP00066.local"

# Set *Either* your computers ip address or hostname. Please note if using
# your_hostname that this must be resolvable to the Robot.

your_ip=$(/sbin/ip -o -4 addr list enp0s3 | awk '{print $4}' | cut -d/ -f1)
...
#
# Comands to run after intera environment is up
# Run the scripts for the interface with sawyer
#
